# Sprint Planning - MCP Agent Orchestrator

This directory contains all sprint plans for the MCP Agent Orchestrator project.
...
**Deliverables:**
- CLI for standalone usage (`agent-orchestra` command)
