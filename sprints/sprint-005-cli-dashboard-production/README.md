...
program
  ...
  .description("CLI for MCP Agent Orchestrator")
  .version("0.1.0");
...
```json
{
  ...
  "repository": {
    "type": "git",
    "url": "https://github.com/vladddev/mcp-agent-orchestrator.git"
  },
  "bugs": {
    "url": "https://github.com/vladddev/mcp-agent-orchestrator/issues"
  },
  "homepage": "https://github.com/vladddev/mcp-agent-orchestrator#readme"
}
```
