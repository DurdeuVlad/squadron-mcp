...
This document defines clear roles, coordination protocols, and token optimization strategies for multi-agent workflows in Squadron development. This is both the **development guide** (how to build this) and the **product spec** (what this orchestrator will enable).
