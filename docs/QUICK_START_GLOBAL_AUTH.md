...
**Then you don't need to configure anything!** The Squadron will automatically detect your existing login sessions.
...
The Squadron **reads these same files** - no duplication needed!
